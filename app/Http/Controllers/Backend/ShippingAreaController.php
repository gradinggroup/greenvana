...
class ShippingAreaController extends Controller
{
    ...
    public function shippingStore(Request $request)
    {
        ...
        $notification = array(
            'message' => 'Shipping Area Berhasil Di Tambahkan!',
            'alert-type' => 'success',
        );
    ...
    public function deleteShipping($id)
    {
        ...
        $notification = array(
            'message' => 'Shipping Area Berhasil Di Hapus!',
            'alert-type' => 'info',
        );
    ...
    public function editShipping($id)
    {
        ...
        return view('admin.shipping.edit_shipping',compact('area','provinces'));
    }
    ...
    public function updateShipping(Request $request, $id)
    {
        ...
        $notification = array(
            'message' => 'Shipping Area Berhasil Di Update!',
            'alert-type' => 'success',
        );
