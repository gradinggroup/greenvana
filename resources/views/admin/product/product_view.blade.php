			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Proudcts List</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
							...
							<tr>
								...
								<td>
									@if($item->discount_price == NULL)
										<span class="bagde badge-danger badge-pill">No Discount</span>
									@else
										@php
											$amount = $item->selling_price - $item->discount_price;
											$discount = ($amount/$item->selling_price) * 100; 
										@endphp
										<span class="bagde badge-success badge-pill">{{ round($discount) }} %</span>
									@endif
								</td>
								...
								<td>
									<a href="{{ route('product.edit',$item->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
									<a href="{{ route('product.delete',$item->id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash"></i></a>
									@if($item->status === 1)
