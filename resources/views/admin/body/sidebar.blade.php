    ...
    <section class="sidebar">	
				 ...
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">					 	
						  ...
						  <h3><b>GreenVana</b> Marketplace</h3>
					 </div>
				</a>
			</div>
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{ ($prefix == '/reports')? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'admin.reports')? 'active':'' }}"><a href="{{ route('admin.reports') }}"><i class="ti-more"></i>All Report</a></li>
          </ul>
        </li>   
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
			<li><a href="/store-address/create"><i class="ti-more"></i>Add Ongkir</a></li>
		  </ul>
        </li>  
