...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	...
	@else
	<table class="table" id="couponFild">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Discount Code</span>
					<p>Masukkan Jika Anda Mempunyai Kupon Diskon</p>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<a href="{{ route('checkout') }}" type="submit" class="btn btn-primary checkout-btn">Proses Untuk CheckOut</a>
						</div>
					</td>
				</tr>
		</tbody><!-- /tbody -->
