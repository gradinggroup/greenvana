...
<body>
	...
	<table width="100%" style="background: #F7F7F7; padding: 0 20px 0 20px;">
		<tr>
			<td valign="top">
				<h2 style="color: #8cc63f; font-size: 26px;"><strong>GreenVana</strong></h2>
			</td>
			<td align="right" style="margin-right: 20px;">
				<pre>
					GreenVana Marketplace
					Email: greenvana.id@gmail.com<br>
					Phone: 0812-1816-5942 <br>
				</pre>
			</td>
		</tr>
	</table>
	...
	<table width="100%">
		<thead style="background-color: #8cc63f; color: #FFFFFF;">
			<tr class="font">
				<th>Image</th>
				<th>Product Name</th>
				<th>Size</th>
	...
	<table width="100%" style="padding: 0 10px 0 10px;">
		<tr>
			<td align="right">
				<h2><span style="color:#8cc63f;"> Subtotal: Rp. {{ $order->amount }}</span></h2>
				<h2><span style="color:#8cc63f;"> Total: Rp. {{ $order->amount }}</span></h2>
				<h3><span style="color:#547726">Payment Status: {{ $order->status }}</span></h3>
			</td>
		</tr>
	</table>

	<div class="thanks mt-3">
		<p>Terima Kasih Telah Membeli Dari Produk Kami</p>
	</div>
